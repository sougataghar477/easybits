...
useEffect(() => {
  ...
  return (
    <>
      ...
      <p>
        on <span className="font-bold italic">{new Date(blogDetails.date).toLocaleDateString()}</span>
      </p>
      <img src="https://images.unsplash.com/photo-1496449903678-68ddcb189a24?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"/>
